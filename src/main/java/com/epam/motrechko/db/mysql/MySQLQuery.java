...
public final class MySQLQuery {
    ...
    public static final String SELECT_ALL_UNVERIFIED_REPORTS = "SELECT  idReport, idUsers , type, status,date,users.firstName,users.lastName  FROM tax.report  JOIN reporttype  " +
