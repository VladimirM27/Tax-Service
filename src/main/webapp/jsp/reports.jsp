            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table my-0" id="dataTable">
                                ...
                                <c:forEach items="${reportViewList}" var="item">
                                    <tr>
                                        ...
                                        <th><c:out
                                                value="${item.inspectorName == null ? '-' : item.inspectorName}"/></th>
                                        <th><c:out
                                                value="${item.inspectorLastname == null ? '-' : item.inspectorLastname}"/></th>
                                        ...
                                        <c:choose>
                                            <c:when test="${item.status == 'REJECTED'}">
                                                <td><a class="btn btn-primary"
                                                       href="${pageContext.request.contextPath}/controller?command=FillReport&idReport=${item.idReport}">Edit
                                                    report</a></td>
                                            </c:when>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <nav class="d-lg-flex justify-content-lg-end" aria-label="Navigation for reports">
                                    <ul class="pagination">
                                        <c:if test="${page != 1}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${pageContext.request.contextPath}/controller?command=Reports&page=${page - 1}&recordsPerPage=${recordsPerPage}">Previous</a>
                                            </li>
                                        </c:if>
                                        ...
                                        <c:forEach begin="1" end="${totalPages}" var="i">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li class="page-item"><a class="page-link"
                                                                             href="${pageContext.request.contextPath}/controller?command=Reports&page=${i}&recordsPerPage=${recordsPerPage}">${i}</a>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        ...
                                        <c:if test="${page lt totalPages}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${pageContext.request.contextPath}/controller?command=Reports&page=${page+1}&recordsPerPage=${recordsPerPage}">Next</a>
                                            </li>
                                        </c:if>
                                    </ul>
                                </nav>
