                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/Tax-service/controller" method="post">
                            <input id="POST-command" type="hidden" name="command" value="UpdateReport" >
                            <input id="idReport" type="hidden" name="idReport" value="${report.idReport}">
                            <div class="mb-3"></div>
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <option value="1">tourist tax</option>
                                        <option value="6">tax on rent payment</option>
                                        <option value="5">for parking spaces for vehicles</option>
                                        <option value="2">on property status and income</option>
                                        <option value=""></option>
                                    </select>
                                    </div>
                                    <div class="col"><label class="form-label" for="email">Filing date</label><input class="form-control" id="hire-date-1" type="date"  value="${report.date}" name="date"></div>
                                </div>
                                <div class="mb-3"></div>
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col"><label class="form-label" for="email">Amount of income</label><input class="form-control" value="${report.incomeSum}" type="text" required="" minlength="1" pattern="\d+\.\d+" name="incomeAmount"></div>
                                        <div class="col"><label class="form-label" for="email">Tax amount</label><input class="form-control"  value="${report.taxSum}" type="text" required="" minlength="1" pattern="\d+\.\d+" name = "taxAmount"></div>
                                    </div>
                                    <div class="mb-3"></div>
                                </div>
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col"><label class="form-label" for="email">fine ( as needed ) </label><input class="form-control" value="${report.fine}" type="text" required="" minlength="1" pattern="\d+\.\d+" name="fine"></div>
                                        <div class="col"><label class="form-label" for="email">penny ( as needed )<br></label><input class="form-control"  value="${report.penny}" type="text" required="" minlength="1" pattern="\d+\.\d+" name="penny"></div>
                                    </div>
                                    <div class="mb-3"></div>
                                </div>
                            </div>
                            <div class="mb-3"><label class="form-label" for="message">user comment</label><textarea class="form-control" id="message" name="userComment">${report.commentUser}"</textarea></div>
                            <div class="mb-3"><label class="form-label" for="message">Inspector comment</label><textarea readonly class="form-control" id="message" name="inspectorComment">${report.commentInspector}</textarea></div>
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-6 col-xl-12 button"><button class="btn btn-primary d-block w-100" type="submit">Send Form</button></div>
                                </div>
                            </div>
                        </form>
